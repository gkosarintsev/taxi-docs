...
По запросу могу дать ссылку на тестовый сервер. Сайт запускается на Github Codespaces, который сделан для разработки и поэтому контейнеры засыпают через полчаса бездействия. Чтобы запустилось, мне сначала надо проделать некоторые действия.
